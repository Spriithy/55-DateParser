...
/**
 * The Tokenizer class is responsible of splitting an input text as Tokens.
 * 
...
public class Tokenizer {
	...
	public Token tokenize() {
		...
		// If matches a digit, the parse the next integer. We don't really care
		...
		// We really want to discard other characters, punctuation etc
	...
	private Token word() {
		...
		// see com.spriithy.dateparser.Month for the pattern description
